...
"""
t1=time.time()
my_dataset=pts_cls_dataset(datalist_path='/home/gaoyuzhe/Downloads/3d_data/modelnet/test_files.txt')
a=my_dataset[1]

t2=time.time()
print (t2-t1,'s')

data_loader = torch.utils.data.DataLoader(my_dataset,batch_size=4, shuffle=True, collate_fn=pts_collate)
